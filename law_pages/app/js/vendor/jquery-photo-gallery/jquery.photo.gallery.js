...
$.extend({
	//打开图片查看器
	openPhotoGallery : function(obj,src){
		...
		var iframeEle = document.getElementById("J_pg");
		removeElement(iframeEle);
		$("#J_pg").remove();
		$("<iframe></iframe>").appendTo("body")
			.attr("id", "J_pg")
			.attr("src", "js/vendor/jquery-photo-gallery/gallery.html")
			.css({
				position : "fixed",
