angular.module('sbAdminApp').controller('AIOCourtSetpBoxCtrl', function (PoliceConfig,PoliceService,PrejudgeConfig,AdminConstant,$location,$scope, $stateParams, $state,$rootScope, $http, $log, AlgorithmConfig, AlgorithmService, DictionaryConfig,PrejudgeService, toaster, $filter,IdentityService) {
    $scope.prejudgeService = PrejudgeService;
    $scope.lawCase = {
    createDate: DictionaryConfig.getDate(),
    regionName: "江苏省-南京市-建邺区",
    applicantArray:[{
            personType: '0',
            household: '0',
            responsibleRate: 100,
