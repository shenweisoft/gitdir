...
function init(options) {
  ...
  accountInfo.userName = options.data.userName || accountInfo.userID;
...
function updateWebRoom(roomId){
  let Server = wx.getStorageSync("dataUrl")
  ...
  var url = Server + '/adjust/updateAdjustVideoRoom';
  var data = {
    id: wx.getStorageSync("caseId"),
    videoId: roomId
  }

  var webRoomId = wx.getStorageSync("webRoomId")
  console.log("caseId" + wx.getStorageSync("caseId") + "webRoomId:" + webRoomId);
  if (webRoomId){
    url = Server + '/adjust/updateSysChatRoom';
    data = {
      id: wx.getStorageSync("webRoomId"),
      videoRoomId: roomId
    }
  }
  //更新视频房间ID
